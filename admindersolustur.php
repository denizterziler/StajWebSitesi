    ...
    <div class="content-wrapper">
        <center>
            ...
            <div class="container-main">
                <form id="myForm">
                    <h3 style="padding-top:30px;">DERS OLUŞTUR</h3>
                    <?php
                    include("config.php");

                    ?>
                    <input type="text" name="Ders Adı" id="dersad" placeholder="Ders Adı Gir">
                    ...
                    <select style="margin-top:30px;" id="sinifid" class="form-select dropdown">
                        <option disabled selected>Sınıf Seçiniz</option>
                    ...
                    <a style="margin-bottom: 40px;">
                        <input id="btngnd" class="btn btn-primary" type="submit" value="Oluştur">
                    </a>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            form.addEventListener('submit', function (event) {
                ...
                var selecteddersad = document.getElementById('dersad').value;
