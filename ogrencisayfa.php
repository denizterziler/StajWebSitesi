    ...
    <div class="content-wrapper">
        <center>
            <div class="container-main">
                ...
                //$query = "SELECT ak_ad, ogr_mail, egt_id, bolum_id, sube_id, sinif_id FROM ogrenci";
                $result = $conn->query($sql);
                ?>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($data = $result->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $data['ogr_email']; ?>
                                </td>
                                <td>
                                    <?php echo $data['egt_id']; ?>
                                </td>
                                <td>
                                    <?php echo $data['bolum_id']; ?>
                                </td>
                                <td>
                                    <?php echo $data['sube_id']; ?>
                                </td>
                                <td>
                        ...
                        <tr>
                            <td colspan="8">No data ogrencisayfa</td>
                        </tr>
                    <?php } ?>
                </table>
            </div>
